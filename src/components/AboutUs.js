            ...
            <section className="mission-section">
                <div className="who-we-are">
                    <div className="content">
                        <h2>Tentang Kami</h2>
                        <p>
                        Maxy Academy berkomitmen untuk menjembatani kesenjangan pendidikan dengan menghubungkan para donatur dengan siswa yang membutuhkan. Misi kami adalah menumbuhkan bakat dan potensi untuk masa depan yang lebih cerah.
                        </p>
                    </div>
