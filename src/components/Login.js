    ...
    <>
      ...
      <div className="flex w-full h-screen">
        ...
        <div
          ...
          style={{ backgroundImage: 'url("https://static.vecteezy.com/system/resources/previews/011/382/129/original/young-man-joining-online-learning-3d-character-illustration-png.png")' }}
        >
          {/* Gambar akan di sini */}
        </div>
          ...
          <div className="bg-white shadow-md rounded-lg p-8 w-96">
            ...
            <div className="mt-4 flex justify-center space-x-4">
              ...
              <button className="flex items-center justify-center w-10 h-10 border border-gray-300 rounded-full hover:bg-gray-100 transition duration-200">
                <img
                  src="data:image/svg+xml;base64,"
                  alt="Google"
                  className="w-6 h-6"
                />
              </button>
