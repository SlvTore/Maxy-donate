...
function MetodePembayaran() {
    ...
    const paymentMethods = [
        { name: 'BNI', logo: '/bni-logo.png' },
        { name: 'BRI', logo: '/bri-logo.png' },
        { name: 'Mandiri', logo: '/mandiri-logo.png' },
        { name: 'BCA', logo: '/bca-logo.png' },
        { name: 'OVO', logo: '/ovo-logo.png' },
        { name: 'DANA', logo: '/dana-logo.png' },
        { name: 'Bank Mega', logo: '/bankmega-logo.png' },
        { name: 'BSI', logo: '/bsi-logo.png' },
    ];
                    ...
                    <div className="d-flex justify-content-center gap-3">
                        {donationOptions.slice(0, 3).map((amount) => (
                            <button
                                ...
                                className={`btn ${selectedNominal === amount ? 'btn-black-active' : 'btn-black'} fw-bold fst-italic`}
                                style={{ borderRadius: '0', border: '1px solid black', width: '140px' }}>
